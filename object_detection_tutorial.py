...
def getposition_center(width,height,s_boxes,s_scores,):
    center_dic = {}
    for i in range(len(s_classes)):
        ...
        #print("################")
        #center_dic.update({class_name:[score,(xmax+xmin)/2,(ymax+ymin)/2]})
    return center_dic
...
with detection_graph.as_default():
  with tf.Session(graph=detection_graph) as sess:
    #print(detection_graph.get_name_scope())
    ...
    for image_path in TEST_IMAGE_PATHS:
        ...
        w,h = image.size
        center_dic = getposition_center(w,h,s_boxes,s_scores)
        #print(center_dic)
